...
<label className="inline-flex items-center cursor-pointer">
  ...
  <div className="relative w-8 h-4 bg-gray-200 peer-focus:outline-none outline-none border-none rounded-full peer dark:bg-Green peer-checked:after:translate-x-[1.5px] after:translate-x-[186%] after:content-[''] after:absolute after:top-[3.5px] after:start-[2px] after:bg-[#DCFCE7] shadow-[inset_2px_2px_0px_0px_#0C0A0980] peer-checked:shadow-[1px_1px_0px_0px_#16653480] duration-300
