        ...
        <>
            <div className=" h-[70vh] overflow-y-scroll ">
                <label class="inline-flex items-center cursor-pointer">
                    ...
                    <div class="relative w-8 h-4 bg-gray-200 peer-focus:outline-none   rounded-full peer dark:bg-Green peer-checked:after:translate-x-[1px] after:translate-x-[193%] peer-checked:after:border-white after:content-[''] after:absolute after:top-[3px] after:start-[2px] after:bg-[#DCFCE7] shadow-[inset_2px_2px_0px_0px_#0C0A0980] peer-checked:shadow-[1px_1px_0px_0px_#16653480] duration-300
                            ...
                            <div className="bg-offWhite p-2 py-[6px] rounded-[4px] mb-1">
                                <div className="flex justify-between items-center">
                                    <div className="flex gap-2 items-center">
                                        ...
                                        <div>
                                            <p className="font-bold text-base text-Green max-w-[150px] !leading-1lg"><span className='text-grey font-normal text-base !leading-1lg'>Based.eth</span> <span className='text-lightGrey font-normal text-xs !leading-1lg'>id: 73</span> {data.content1} <span className="font-normal text-xs  !leading-1lg">pts</span></p>
                                        </div>
                                    </div>
                                    <div>
                                        <CommonBtn icon={data.icon}
                                            text={data.text} className={`${(index === 2 || index === 9 || index === 12) ? "!gap-2 opacity-50 pointer-events-none shadow-none" : ""
                                                } `} />
                                    </div>
                                </div>
                            </div>
